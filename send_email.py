...
if __name__ == '__main__':
    ...
    email_list = [os.getenv('TO_EMAIL1'), os.getenv('TO_EMAIL8'), os.getenv('TO_EMAIL7'), os.getenv('TO_EMAIL2'), os.getenv('TO_EMAIL3'), os.getenv('TO_EMAIL4'), os.getenv('TO_EMAIL5'), os.getenv('TO_EMAIL6') ]
